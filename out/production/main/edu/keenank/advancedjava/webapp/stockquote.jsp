<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<jsp:useBean id="search" class="edu.keenank.advancedjava.model.StockSearch" scope="request"/>
...
<form name="myform" action="servlets/StockSearchServlet/" method="post">
    <fieldset>
        ...
        Start Time: <br />      <input type="datetime-local" name="from"><br /><br />
        End Time: <br />        <input type="datetime-local" name="until"><br /><br />
